...
class IRWGANModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        if opt.phase == 'train' or opt.phase == 'resume' or opt.phase=='test':
        ...
        if opt.phase == 'train' or opt.phase == 'resume' or opt.phase=='test':  # define discriminators
    ...
    def model_name(self):
        ...
        name = "IrwGAN_{}_{}_{}_{}_{}".format(opt.task, opt.gan_type, opt.batch_size, opt.beta_mode, opt.netD)
        if opt.beta_mode in ['A', 'AB']:
